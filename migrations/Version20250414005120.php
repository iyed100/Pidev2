 ...
 */
final class Version20250414005120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance DROP FOREIGN KEY assurance_ibfk_1
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance DROP FOREIGN KEY assurance_ibfk_1
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance ADD CONSTRAINT assurance_ibfk_1 FOREIGN KEY (id_reservation) REFERENCES reservation (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE coworking_space CHANGE prixParHeure prix_par_heure DOUBLE PRECISION NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX transportId ON route
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE route CHANGE transportId transport_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE route ADD CONSTRAINT FK_2C420799909C13F FOREIGN KEY (transport_id) REFERENCES transport_means (id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_2C420799909C13F ON route (transport_id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE coworking_space CHANGE prix_par_heure prixParHeure DOUBLE PRECISION NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE coworking_space ADD CONSTRAINT coworking_space_ibfk_1 FOREIGN KEY (hotel_id) REFERENCES hotel (id) ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE route DROP FOREIGN KEY FK_2C420799909C13F
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_2C420799909C13F ON route
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE route CHANGE transport_id transportId INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX transportId ON route (transportId)
        SQL);
        $this->addSql(<<<'SQL'
